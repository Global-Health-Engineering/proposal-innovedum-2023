...
Each identified challenge is addressed by an associated work package, goal and measurable objective as presented in this public Google Sheet: https://docs.google.com/spreadsheets/d/1srD0UPBMVknayk0ni6iOma07yHvpzAOYg3jS2KEYVOI/edit#gid=0 and Table 1 in the Appendix. 

We identified two to three specific activities per objective, which are presented in this public Google Sheet: https://docs.google.com/spreadsheets/d/1ATIyMmpVnVfX8Z17WUYYu1wjMx6rNA4snTOpVj4V5hM/edit#gid=0 and Table 2 in the Appendix. 
...
**Objective 1:** `r get_proj_details(proj_goals, work_package = "WP3", col = objective)`

### `r get_proj_details(proj_goals, work_package = "WP4", col = wp)`

**Goal:** `r get_proj_details(proj_goals, work_package = "WP4", col = goal)`

**Objective 1:** `r get_proj_details(proj_goals, work_package = "WP4", col = objective)`
